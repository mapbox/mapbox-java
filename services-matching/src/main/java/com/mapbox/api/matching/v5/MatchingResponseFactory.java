    ...
    for (MapMatchingMatching matching : matchings) {
      modifiedMatchings.add(matching.toBuilder().routeOptions(
        RouteOptions.builder()
          ...
          .annotations(ParseUtils.parseToStrings(mapboxMapMatching.annotations(), ","))
          .approaches(ParseUtils.parseToStrings(mapboxMapMatching.approaches()))
          .language(mapboxMapMatching.language())
          .radiuses(ParseUtils.parseToStrings(mapboxMapMatching.radiuses()))
          ...
          .waypointIndices(ParseUtils.parseToIntegers(mapboxMapMatching.waypointIndices()))
          .waypointNames(ParseUtils.parseToStrings(mapboxMapMatching.waypointNames()))
