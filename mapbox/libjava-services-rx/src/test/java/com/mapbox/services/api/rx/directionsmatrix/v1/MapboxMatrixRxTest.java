...
import com.mapbox.services.api.directionsmatrix.v1.models.MatrixResponse;
...
public class MapboxMatrixRxTest {
  ...
  public void testSanityRX() throws ServicesException {
    MapboxMatrixRx client = new MapboxMatrixRx.Builder()
    ...
    TestObserver<MatrixResponse> testObserver = new TestObserver();
    ...
    MatrixResponse response = (MatrixResponse) events.get(0).get(0);
