...
public class TurfLineSliceActivity extends AppCompatActivity {
  ...
  private void drawSlicedRoute() {
    try {
      LineString lineString = TurfMisc.lineSlice(
        Point.fromCoordinates(routePoints.get(5)),
        Point.fromCoordinates(routePoints.get(20)),
        LineString.fromCoordinates(routePoints)
      );
