...
public class LocationUpdatedThreadTest extends BaseNavigationTest {
  ...
  public void before() throws IOException, ServicesException {
    InputStream input = this.getClass().getClassLoader().getResourceAsStream(NAVIGATION_FIXTURE);
    DirectionsResponse response = new Gson().fromJson(convertStreamToString(input), DirectionsResponse.class);
