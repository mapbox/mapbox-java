...
- Added `RouteOptions.Builder#unrecognizedProperties` to set custom request parameters to an url generated by `RouteOptions#toUrl`. [#1420](https://github.com/mapbox/mapbox-java/pull/1420)
