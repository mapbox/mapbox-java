...
- Added `RouteOptions.Builder#unrecognizedProperties` to set custom request parameters for `RouteOptions`. [#1420](https://github.com/mapbox/mapbox-java/pull/1420)
