        ...
        map.setOnMapClickListener(new MapboxMap.OnMapClickListener() {
            ...
            public void onMapClick(@NonNull LatLng point) {
                ...
                if (polygon != null) {
                    ...
                    try {
                        boolean pointWithin = TurfJoins.inside(Position.fromCoordinates(withinMarker.getPosition().getLongitude(), withinMarker.getPosition().getLatitude()), polygonPositions);
