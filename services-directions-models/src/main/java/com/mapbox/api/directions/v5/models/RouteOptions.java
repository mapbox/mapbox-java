...
public abstract class RouteOptions extends DirectionsJsonObject {
  ...
  public abstract static class Builder extends DirectionsJsonObject.Builder<Builder> {
    ...
    /**
     * Use this method to add custom request parameters to an url generated by `RouteOptions#toUrl`.
     * Custom parameters are not present in model yet but supported on the Directions API,
     * for example experimental parameters.
