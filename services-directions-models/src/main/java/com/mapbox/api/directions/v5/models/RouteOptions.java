...
public abstract class RouteOptions extends DirectionsJsonObject {
  ...
  public abstract static class Builder {
     ...
     * for {@link DirectionsCriteria#PROFILE_WALKING} and {@link DirectionsCriteria#PROFILE_CYCLING}.
     *
     * @param continueStraight a boolean value representing whether or not continueStraight was enabled or
     *                         not during the initial request
     * @return this builder for chaining options together
     */
    @NonNull
     ...
     * {@link DirectionsCriteria#PROFILE_CYCLING}: {@link DirectionsCriteria#EXCLUDE_FERRY}
     *
     * @param exclude a string matching one of the {@link DirectionsCriteria.ExcludeCriteria} exclusions
     * @return this builder for chaining options together
     */
    @NonNull
     ...
     * conjunction with {@link RouteOptions#steps()}=true.
     *
     * @param roundaboutExits a boolean value representing whether or not roundaboutExits is enabled or disabled
     * @return this builder for chaining options together
     */
    @NonNull
